    ...
    .mb-4.flex.flex-col.justify-center.items-center.w-full
      +if('progress != "done"')
        .relative.pt-1.w-full.text-center {progress}
          .overflow-hidden.h-2.mt-4.text-xs.text-center.flex.rounded.bg-blue-200
        ...
        +else()
          .mb-4 Training complete!!
          .inline-flex.mb-4.justify-between.w-full.flex-wrap
            +each('modes as mode')
              .inline-flex.items-center.mr-4(class='last:mr-0')
